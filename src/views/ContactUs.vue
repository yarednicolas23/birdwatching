...
export default {
  ...
  data() {
      return {
        ...
        "description":'Thank you for contacting us. We will respond as soon as possible. Also, you can call to the cell phone (+57)3214465931 or click on the WhatsApp button in each tour description'
      }
  },
  methods: {
    getSrc(name) {
